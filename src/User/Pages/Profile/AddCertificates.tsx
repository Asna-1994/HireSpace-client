        ...
        <div className="max-w-6xl mx-auto mt-2 bg-white p-8 rounded-xl shadow-lg grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg shadow-md">
            <h3 className="text-2xl font-semibold text-blue-700 mb-6 text-center">
              {editIndex !== null ? "Update Certificates" : "Add Certificates"}
            </h3>
            <form onSubmit={handleAddOrUpdate} className="space-y-6">
              {[
                { label: "Certificate Title", name: "certificateTitle", placeholder: "e.g., ABC Corp" },
                { label: "Description", name: "description", placeholder: "e.g., Front End Developer" },
                { label: "Issuer", name: "issuer", placeholder: "e.g., 2022" },
                { label: "IssuedDate", name: "issuedDate", placeholder: "e.g., 2020-01-01" },
                { label: "CertificateUrl", name: "certificateUrl", placeholder: "e.g., 2022-01-01" },
          ...
          <div>
            ...
            {certificates?.length === 0 ? (
              <p className="text-gray-600 text-center">No Certificate details added yet.</p>
            ) : (
                ...
                {certificates?.map((cert, index) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-lg font-medium text-gray-800">{cert.description}</p>
                      <p className="text-gray-600">
                        {cert.issuer} - {cert.issuedDate}
                      </p>
                      <p className="text-gray-600"> {cert.certificateUrl}</p>
                    </div>
