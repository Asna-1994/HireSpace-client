...
const initialState: AuthState = {
  ...
  const authSlice = createSlice({
    ...
    reducers: {
      ...
      companyLogin: (state, action: PayloadAction<{ company: Company; token: string; user? : User }>) => {
...
export const { userLogin,companyLogin, logout,companyUpdate, userUpdate } = authSlice.actions;
