...
//   const [selectedFile, setSelectedFile] = useState<File | null>(null);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try{
const response = await axiosInstance.patch(`/company/update-basic-detail/${company?._id}`, formData)
...
dispatch(companyUpdate(updatedCompany))
  ...
  const handleAdditionalSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
