          ...
          <div className="max-w-4xl mx-auto">
            ...
            {isVerified ? (
              <p className="text-lg mb-6">
                Your account is verified! Start posting jobs and managing
                candidates today.
              </p>
            ) : company?.verificationDocument.url ? (
              <p className="text-lg mb-6">
                Your documents are under review. Once approved, you can start
                posting jobs.
              </p>
            ) : (
              <p className="text-lg mb-6">
              ...
              <div className="bg-white shadow-md p-6 rounded-lg text-center">
                ...
                {company?.verificationDocument.url && isVerified ? (
                  <p className="text-green-600 font-medium">
                    Your company is verified. You can start posting jobs and
                    hiring.
                  </p>
                ) : company?.verificationDocument.url ? (
