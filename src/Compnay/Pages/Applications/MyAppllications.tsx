    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 min-h-screen">
        <div className="bg-gradient-to-r from-blue-400 to-purple-500 shadow-lg text-white rounded-lg p-6 text-center">
          ...
          <p className="mt-2 text-base sm:text-lg">Manage job applications efficiently.</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {applications.map((application) => (
              <div key={application._id} className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-blue-500">
                <h3 className="text-xl font-semibold text-gray-800 flex items-center">
                  <FaUser className="mr-2 text-blue-500" /> {application.userId.userName}
                </h3>
                <p className="text-gray-800">{application.userId.email}</p>
                <p className="text-lg"><strong>Job:</strong> {application.jobPostId.jobTitle}</p>
                <p className="text-lg"><strong>Applied On:</strong> {new Date(application.appliedDate).toLocaleDateString()}</p>
                <span
                ...
                <Link to={`/company/applications/${application._id}`} state={{ application }} className="block mt-3 text-blue-600 hover:underline">
                  View Details
                </Link>
              </div>
            ))}
