...
//               <h2 className="text-xl font-bold text-gray-800 md:text-2xl">User List</h2>
...
//         onRequestClose={closeModal}
//         contentLabel="Block User Confirmation"
//         className="max-w-sm p-6 mx-auto mt-24 bg-white rounded shadow-lg"
...
const UserList = () => {
  ...
  // Mobile view renders a card-based layout for each user
      ...
      <div className="flex flex-col pt-16 lg:flex-row">
        ...
        <div className="flex-1 p-4 transition-all duration-300 lg:ml-64">
          <div className="p-4 bg-white rounded-lg shadow-md md:p-6">
            {/* Title and search bar */}
            {/* <div className="flex flex-col items-start justify-between gap-4 mb-6 md:flex-row md:items-center">
              <h2 className="text-xl font-bold sm:text-2xl sm:text-center">User List</h2>
              <div className="w-full md:w-auto">
                <input
                  type="text"
                  placeholder="Search users..."
            ...
            <h2 className="text-xl font-bold sm:text-2xl">User List</h2>
            <input
              type="text"
              placeholder="Search users..."
              value={searchTerm}
