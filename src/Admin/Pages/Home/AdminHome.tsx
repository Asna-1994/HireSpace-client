...
import { FiTrendingUp, FiTrendingDown, FiUsers, FiBriefcase, FiAward, FiAlertTriangle, FiFileText } from 'react-icons/fi';
...
/>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                <h2 className="text-lg font-semibold text-gray-800 mb-4">Platform Growth</h2>
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={stats.monthlyGrowth}>
                      ...
                      <Line type="monotone" dataKey="companies" stroke="#00C49F" name="Companies" />
                      <Line type="monotone" dataKey="jobs" stroke="#FFBB28" name="Jobs" />
                      <Line type="monotone" dataKey="applications" stroke="#FF8042" name="Applications" />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </div>
