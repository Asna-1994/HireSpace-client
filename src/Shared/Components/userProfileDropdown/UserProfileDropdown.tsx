...
//       {user?.userName.slice(0, 2).toUpperCase()} {/* First two letters */}
//     </span>
//   )}
// </button>
...
//             {/* User Details */}
//             <Link to={`/user/view-profile/${user._id}`}>
...
//         {user?.isPremium && (
//           <span className="mt-1 bg-yellow-400 text-black text-xs px-1 py-1 rounded-full font-semibold flex justify-center items-center">
//             Premium
//           </span>
//         )}
